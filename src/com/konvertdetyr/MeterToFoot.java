...
public class MeterToFoot extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.metertofoot);
				...
				if (lexo.getText().toString().matches("")){
					Toast.makeText(getApplicationContext(), "SHKUANI NJË NUMËR",Toast.LENGTH_LONG).show();
				     ...
				     if (lexonr>9999){
				    	 ...
				    	 float rezultati=llog.MeterToFeet(lexonr);				    	 form.format(rezultati);
				    	 String afisho=form.format(rezultati);
				    	 Rez.setText(afisho+" foot");
				     	}    
