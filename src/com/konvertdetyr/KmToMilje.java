...
public class KmToMilje extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.kmtomilje);
				...
				if (lexo.getText().toString().matches("")){
					Toast.makeText(getApplicationContext(), "SHKUANI NJË NUMËR",Toast.LENGTH_LONG).show();
				     ...
				     if (lexonr>9999){
				    	 ...
				    	 float rezultati=llog.kmToMilje(lexonr);
				    	 form.format(rezultati);
				    	 //String afisho=Float.toString(rezultati);
				    	 String afisho=form.format(rezultati);
				    	 Rez.setText(afisho+" milje");
...
VINI RE : Nderfaqja ne konsole te jete iteraktive me perdoruesin, 
te jepen njoftime pershendetese si dhe sqarime per cdo veprim te perdoruesit. 
Secila prej ketyre konvertimeve te jete nje metode me vete, ndersa ne main te behen thirrjet perkatese. 
Mbase eshte me thjeshte qe keto metoda te vendosen si statike, me fjalen celes static.
*/
